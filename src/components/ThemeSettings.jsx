...
const ThemeSettings = () => {
  ...
  return (
  <div className='px-3' style={{position:'fixed' , top:'0', right:'0' , height:'100vh',background:'white',width:'300px',boxShadow:'grey -4px 0px 9px 0px',borderTopLeftRadius:'20px',borderBottomLeftRadius:'20px',transition:'.5s',zIndex:'100'}} >
