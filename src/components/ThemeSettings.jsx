...
const ThemeSettings = () => {
  ...
  return (
  <div className='px-3' style={{position:'fixed' , top:'0', right:'0' , height:'100vh',background:'white',width:'300px',boxShadow:'2px 3px 5px gray',borderTopLeftRadius:'20px',borderBottomLeftRadius:'20px',transition:'.5s',zIndex:'100'}} >
